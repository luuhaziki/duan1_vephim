...
<!--login-->
	<div class="modal fade st_pop_form_wrapper" id="myModal" role="dialog">
		<div class="modal-dialog">
			<form class="modal-content" method="post" action="<?=$_SERVER['REQUEST_URI']?>">
				...
				<button name="dang_nhap" class="btn btn-danger">Đăng nhập
				</button>
	...
	<div class="modal fade st_pop_form_wrapper" id="myModa3" role="dialog">
		<div class="modal-dialog">
			<form class="modal-content" method="post" action="<?=$_SERVER['REQUEST_URI']?>">
                ...
                <div class="st_profile__pass_input st_profile__pass_input_pop float_left">
                    <input type="password" placeholder="Nhập lại mật khẩu" name="mat_khau_nhap_lai">
                </div>
				<div class="st_form_pop_fp float_left">
					<h3><a href="#" data-toggle="modal" data-target="#myModa2" target="_blank">Forgot Password?</a></h3>
				</div>
				<button name="dang_ki" class="btn btn-danger">Đăng kí
				</button>
			</form>
		</div>
	</div>
...
<!-- Mirrored from www.webstrot.com/html/moviepro/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 11:19:42 GMT -->
</html>