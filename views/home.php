            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="prs_upcome_tabs_wrapper">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#best" aria-controls="best" role="tab" data-toggle="tab">PHIM SẮP TỚI</a>
                        </li>
                        <li role="presentation"><a href="#hot" aria-controls="hot" role="tab" data-toggle="tab">BỘ PHIM MỚI NHẤT</a>
                        </li>
                        <li role="presentation"><a href="#trand" aria-controls="trand" role="tab" data-toggle="tab">PHIM HAY NHẤT</a>
                        </li>
                    </ul>
                </div>
            </div>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 prs_upcom_slide_first">
                                                    <div class="prs_upcom_movie_box_wrapper">
                                                        <div class="prs_upcom_movie_img_box">
                                                            <img style="height:400px; object-fit: cover;" src="./public/upload/<?= $phim['image_phim'] ?>" alt="movie_img" />
                                                            <div class="prs_upcom_movie_img_overlay"></div>
                                                            <div class="prs_upcom_movie_img_btn_wrapper">
                                                                <ul>
                                                                    <li><a href="index.php?action=chi_tiet_phim&id_phim=<?= $phim['ma_phim'] ?>">Chi tiết</a>
                                                                    </li>
                                                                    <li><a href="index.php?action=chi_tiet_phim&id_phim=<?= $phim['ma_phim'] ?>">View Trailer</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="prs_upcom_movie_content_box" style="height: 240px;">
                                                            <div class="prs_upcom_movie_content_box_inner">
                                                                <h2><a href="#"><?= $phim['ten_phim'] ?></a></h2>
                                                                <p><?= $phim['ten_theloai'] ?></p> <i class="fa fa-star"></i>
