				...
				<div class="prs_menu_main_wrapper">
					<nav class="navbar navbar-default">
						<div id="dl-menu" class="xv-menuwrapper responsive-menu">
							...
							<ul class="dl-menu">
								<li class="parent"><a href="index.php">Trang Chủ</a>
									<ul class="lg-submenu">
										<li><a href="index-2.html">Index-I</a></li>
								...
								<li class="parent"><a href="index.php?action=movie_category">Danh Mục</a>
									<ul class="lg-submenu">
										<?php
											foreach($list_theloai as $theloai) {
												?>
													<li><a href="index.php?action=movie_category&id_theloai=<?= $theloai['ma_theloai'] ?>"><?= $theloai['ten_theloai'] ?></a></li>
												<?php
											}
										?>
									</ul>
								...
								<li class="parent"><a href="contact.html">Hỗ Trợ</a>
								</li>
							</ul>
						</div>
						<!-- /dl-menuwrapper -->
			...
			<div id="mobile-nav" data-prevent-default="true" data-mouse-events="true">
				...
				<div class="mobile-nav-box">
					<div class="mobile-logo">
						<a href="index-2.html" class="mobile-main-logo">
		...
		<path  d="M39.919,19.833C39.919,8.88,30.984,0,19.959,0C8.937,0,0,8.88,0,19.833
			...
			C37.652,36.448,45.953,40,45.953,40l1.043-8.658C41.41,30.454,38.125,32.244,35.314,34.585z"/>
					...
					<ul class="mobile-list-nav">
						<li>
							<a href=""><?= $nguoi_dung['ten_dang_nhap'] ?? "" ?></a>
						</li>
						<?php
							if($nguoi_dung) {
						...
						<li><a href="movie_single.html">SẢN PHẨM</a>
						</li>
						<li><a href="event_single.html">DANH MỤC</a>
						</li>
						<li><a href="gallery.html">VIDEO</a>
						</li>
					</ul>
				</div>
			</div>
